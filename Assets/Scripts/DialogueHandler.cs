...
public class DialogueHandler : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dialogueInformations[Dialogues.Intro] = new DialogueInformation(new string[] { 
            ...
            "Witch: sigh...",
            "Witch: Being immortal is so lonely. The last time i saw my husband, he asked me to go see the world for him. He knew he’d be gone by the time i returned.he had grown quite old. It was his last wish.", 
